...
import logoIcon from '@/style/images/logophoto1.svg';
import logoText from '@/style/images/VERTEX.svg';
...
function Sidebar({ collapsible, isMobile = false }) {
  ...
  return (
    ...
    >
      ...
      >
        <img src={logoIcon} alt="Logo" style={{ marginLeft: '-4px', height: '40px' }} />
